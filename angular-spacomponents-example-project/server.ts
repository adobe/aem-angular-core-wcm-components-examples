...
export function app() {
    ...
    //server.post([`${APP_ROOT_PATH}*.html`, '/conf/aem-angular-core-spacomponents-example/settings/wcm/templates*.html'], (req, res, next) => {
    server.post([`${APP_ROOT_PATH}*.html`, '/conf/aem-angular-core-spacomponents-example/settings/wcm/templates*.html'], (req, res, next) => {

        const pageModelRootPath = req.headers['model-root-url'] || APP_ROOT_PATH;
